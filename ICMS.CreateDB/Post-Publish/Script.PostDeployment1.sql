...
if not exists (SELECT * FROM  dbo.Role where [Name] = N'Reviewer') BEGIN INSERT INTO dbo.Role  ([Name], [User], [Permission],[BackupDB], [RestoreDB],[RadQuantity],[DoseQuantity],[Unit],[TM],[Certificate],[Customer],[City],[MachineName],[MachineType],[SensorType]) VALUES (N'Reviewer', 28, 16, 28, 16, 30, 30, 30, 30, 31, 30, 30, 30, 30, 30); END																			
...
--if not exists (SELECT * FROM  dbo.[User] WHERE [LoginName] = 'nnQuynh') BEGIN INSERT INTO dbo.[User]  ([LoginName],[FullName],[Password],[RoleId],[IsActive]) VALUES ('nnQuynh' , N'Nguyễn Ngọc Quỳnh ' ,'PJkJr+wlNU1VHa4hWQuybjjVPyFzuNPcPu5MBH56scHri4UQPjvnumE7MbtcnDYhTcnxSkL9ei/bhIVrylxEwg==', 2,1); END															
--if not exists (SELECT * FROM  dbo.[User] WHERE [LoginName] = 'dtmLinh') BEGIN INSERT INTO dbo.[User]  ([LoginName],[FullName],[Password],[RoleId],[IsActive]) VALUES ('dtmLinh' , N'Đặng Thị Mỹ Linh ' ,'PJkJr+wlNU1VHa4hWQuybjjVPyFzuNPcPu5MBH56scHri4UQPjvnumE7MbtcnDYhTcnxSkL9ei/bhIVrylxEwg==', 2,1); END															
--if not exists (SELECT * FROM  dbo.[User] WHERE [LoginName] = 'dtNhung') BEGIN INSERT INTO dbo.[User]  ([LoginName],[FullName],[Password],[RoleId],[IsActive]) VALUES ('dtNhung' , N'Dương Thị Nhung ' ,'PJkJr+wlNU1VHa4hWQuybjjVPyFzuNPcPu5MBH56scHri4UQPjvnumE7MbtcnDYhTcnxSkL9ei/bhIVrylxEwg==', 2,1); END															
--if not exists (SELECT * FROM  dbo.[User] WHERE [LoginName] = 'tvTrung') BEGIN INSERT INTO dbo.[User]  ([LoginName],[FullName],[Password],[RoleId],[IsActive]) VALUES ('tvTrung' , N'Trần Văn Trung ' ,'PJkJr+wlNU1VHa4hWQuybjjVPyFzuNPcPu5MBH56scHri4UQPjvnumE7MbtcnDYhTcnxSkL9ei/bhIVrylxEwg==', 2,1); END															
--if not exists (SELECT * FROM  dbo.[User] WHERE [LoginName] = 'ndNguyen') BEGIN INSERT INTO dbo.[User]  ([LoginName],[FullName],[Password],[RoleId],[IsActive]) VALUES ('ndNguyen' , N'Nguyễn Đăng Nguyên ' ,'PJkJr+wlNU1VHa4hWQuybjjVPyFzuNPcPu5MBH56scHri4UQPjvnumE7MbtcnDYhTcnxSkL9ei/bhIVrylxEwg===', 2,1); END															
